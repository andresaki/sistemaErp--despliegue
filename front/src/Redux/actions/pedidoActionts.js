...
export const getPedidosCliente = (id) => async(dispatch) => {
    try {
        ...
        const {data} = await axios.get(`${apiUrl}/api/pedidosCliente/${id}`); 
...
export const newPedido = (pedidoData) => async ( dispatch ) => {
    ...
    try{
        ...
        const {data} = await axios.post(`${apiUrl}/api/pedido/nuevo`, pedidoData, config)
...
export const deletePedido = (id) => async ( dispatch ) => {
    ...
    try{
        ...
        const {data} = await axios.delete(`${apiUrl}/api/pedido/${id}`)
...
export const getPedidoDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${apiUrl}/api/pedido/${id}`)
        dispatch({
...
export const updatePedido = (id, pedidoData) => async ( dispatch ) => {
    ...
    try{
        ...
        const {data} = await axios.put(`${apiUrl}/api/pedido/${id}`, pedidoData, config)
