...
export const getGastos = () => async(dispatch) => {
    try {
        ...
        const {data} = await axios.get(`${apiUrl}/api/gastos`); 
...
export const newGasto = (gastoData) => async ( dispatch ) => {
    ...
    try{
        ...
        const {data} = await axios.post(`${apiUrl}/api/gasto/nuevo`, gastoData, config)
...
export const deleteGasto = (id) => async ( dispatch ) => {
    ...
    try{
        ...
        const {data} = await axios.delete(`${apiUrl}/api/gasto/${id}`)
...
export const getGastoDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${apiUrl}/api/gasto/${id}`)
        dispatch({
...
export const updateGasto = (id, gastoData) => async ( dispatch ) => {
    ...
    try{
        ...
        const {data} = await axios.put(`${apiUrl}/api/gasto/${id}`, gastoData, config)
